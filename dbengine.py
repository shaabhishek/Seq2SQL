#This piece of code takes in the predicted query and the ground truth query.
#Executes both the queries through the database
#Results are returned
#These results are then later used to compute rewards
#As per the reward structure mentioned in the paper(-2,-1,+1)
